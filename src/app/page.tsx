...
export const metadata: Metadata = {
  title: { absolute: "VRF Service Orange County | Aximus HVAC California" },
  description:
  ...
  return (
    <>
      ...
      <section className="relative bg-[linear-gradient(180deg,#FFFFFF_0%,#F5FAFF_100%)]">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 pt-8 pb-20 sm:pt-10 sm:pb-28 min-h-[560px] grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          <div>
